...
MoveConnectionHandler.prototype.execute = function(context:any) {

  let  connection = context.connection,
      delta = context.delta;

  let  newParent = context.newParent || connection.parent,
  ...
  forEach(connection.waypoints, function(p:any) {
    p.x += delta.x;
    p.y += delta.y;
...
MoveConnectionHandler.prototype.revert = function(context:any) {
